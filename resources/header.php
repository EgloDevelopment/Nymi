<?php
/*
$rate = $_SESSION['rate-limiter'];

$newrate = ($rate + 1);

$_SESSION['rate-limiter'] = $newrate;

if ($_SESSION['rate-limiter'] > $_SESSION['rate-limit']) {
  echo '<script> window.location.href = "../page?a=rate";</script>';
}
...
if ($_SESSION['logout-req'] == 'false') {
  echo '';
} else {
  echo '<script>window.location.href = "../../../../../functions/logout.php";</script>';
}
