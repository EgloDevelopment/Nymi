  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="../../../"><?php echo $foldname ?></a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex">
        <a class="btn btn-outline-success" id="btn5" href="../../../view/folder/list?i=<?php echo $parent ?>&n=<?php echo $foldname ?>">list</a>
